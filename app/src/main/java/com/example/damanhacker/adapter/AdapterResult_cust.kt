...
class AdapterResult_cust(
    private val list: ArrayList<outPutResponse>, private val context: Context
    // private val listener: ItemOnClickListenerView
) : RecyclerView.Adapter<AdapterResult_cust.ViewHolder>() {
    ...
    class ViewHolder(
        ...
        fun bindItem(data: outPutResponse) {
            val listChild: java.util.ArrayList<ReportData> = data.list
            var str = ""
